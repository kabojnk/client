...
public sealed class DtrEntry : IDisposable, IHostedService
{
    ...
    private IDtrBarEntry CreateEntry()
    {
        ...
        var entry = _dtrBar.Get("Cyprus Synchronos");
    ...
    private void Update()
    {
        ...
        if (_apiController.IsConnected)
        {
            ...
            if (pairCount > 0)
            {
                ...
                tooltip = $"Cyprus Synchronos: Connected{Environment.NewLine}----------{Environment.NewLine}{string.Join(Environment.NewLine, visiblePairs)}";
                colors = _configService.Current.DtrColorsPairsInRange;
            }
            else
            {
                tooltip = "Cyprus Synchronos: Connected";
        ...
        {
            text = "\uE044 \uE04C";
            tooltip = "Cyprus Synchronos: Not Connected";
