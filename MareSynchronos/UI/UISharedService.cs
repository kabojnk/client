...
public partial class UiSharedService : DisposableMediatorSubscriberBase
{
    ...
    {
        ColorTextWrapped("Note: The storage folder should be somewhere close to root (i.e. C:\\CyprusStorage) in a new empty folder. DO NOT point this to your game folder. DO NOT point this to your Penumbra folder.", ImGuiColors.DalamudYellow);
        ...
        using (ImRaii.Disabled(_cacheMonitor.MareWatcher != null))
        {
            ...
            {
                FileDialogManager.OpenFolderDialog("Pick Cyprus Synchronos Storage Folder", (success, path) =>
                {
                    if (!success) return;
    ...
    public bool DrawOtherPluginState()
    {
        ...
        {
            ImGui.TextColored(ImGuiColors.DalamudRed, "You need to install both Penumbra and Glamourer and keep them up to date to use Cyprus Synchronos.");
            return false;
        }
